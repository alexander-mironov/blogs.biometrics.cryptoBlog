...
interface CryptographyManager {
     ...
     */
    fun getInitializedCipherForDecryption(keyName: String, iv: ByteArray): Cipher
...
private class CryptographyManagerImpl : CryptographyManager {
    ...
    override fun decryptData(encryptedData: ByteArray, cipher: Cipher): String {
    ...
    private fun getOrCreateSecretKey(keyName: String): SecretKey {
        ...
        paramsBuilder.apply {
            ...
            setUserAuthenticationParameters(
                /* timeout = */ 0,
                /* type = */ KeyProperties.AUTH_BIOMETRIC_STRONG or
